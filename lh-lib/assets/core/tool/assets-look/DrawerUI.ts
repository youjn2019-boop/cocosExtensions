...
class DrawerUI {
    ...
    private createContainer(): void {
        ...
        this.container.id = "node-inspector-drawer";
    ...
    private createToggleButton(): void {
        ...
        this.toggleButton.id = "node-inspector-toggle";
        this.toggleButton.innerHTML = "节\n点\n树";
        this.toggleButton.title = "切换节点调试器";
        if (this.container) {
    ...
    private createContent(): void {
        ...
        this.content.id = "node-inspector-content";
        if (this.container) {
    ...
    private createResizeHandle(): void {
        ...
        this.resizeHandle.id = "node-inspector-resize-handle";
        if (this.container) {
